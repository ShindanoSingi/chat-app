...
function Register() {
     ...
     return (
          <div className='h-screen bg-primary flex items-center  justify-center'>
               <div className='form-container bg-white shadow-md p-5 md:p-8 flex flex-col gap-5 w-96 xs:w-[90%] rounded-lg md:w-[60%] lg:w-[45%] xl:w-[45%]'>
                    ...
                    <input type="password"
                         ...
                         className={user.password ? 'border-green-500 md:py-3 md:text-2xl px-3 py-1 xl:text-3xl' : 'border-red-500 md:py-3 px-3 md:text-2xl py-1 xl:text-3xl'}
                    />
                    <button className={user.name && user.email && user.password ? 'contained-btn md:text-2xl md:py-2 px-3 ' : 'disabled-btn md:text-2xl md:py-3 px-3'} onClick={register}>Register</button>
                    <Link to='/login'
